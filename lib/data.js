...
export const BROKERAGES = [
  { id: "fidelity", name: "Fidelity Investments", short: "Fidelity", color: "#00853f", acats: true, est: "2–3 business days", dtc: "0226", clearing: "National Financial Services LLC", sipc: true },
  { id: "merrill", name: "Merrill Lynch", short: "Merrill", color: "#0a2c6b", acats: true, est: "2–3 business days", dtc: "8862", clearing: "Merrill Lynch, Pierce, Fenner & Smith", sipc: true },
  { id: "schwab", name: "Charles Schwab", short: "Schwab", color: "#0a7ec2", acats: true, est: "2–3 business days", dtc: "0164", clearing: "Charles Schwab & Co., Inc.", sipc: true },
  { id: "vanguard", name: "Vanguard Brokerage", short: "Vanguard", color: "#96151d", acats: true, est: "2–3 business days", dtc: "0062", clearing: "Vanguard Marketing Corporation", sipc: true },
  { id: "etrade", name: "E*TRADE from Morgan Stanley", short: "E*TRADE", color: "#5b2a86", acats: true, est: "2–3 business days", dtc: "0385", clearing: "Morgan Stanley Smith Barney LLC", sipc: true },
  { id: "robinhood", name: "Robinhood Securities", short: "Robinhood", color: "#0a8a2f", acats: true, est: "2–3 business days", dtc: "6769", clearing: "Robinhood Securities, LLC", sipc: true },
];
...
export const FREE_INSURANCE_LIMIT = 20000;
...
// What transfer protection covers (shown on the tracking page).
export const INSURANCE_COVERAGE = [
  "Fraudulent charges & unauthorized transactions",
  "IRS early-withdrawal & tax penalties",
  "Settlement failure or rejected ACATS transfers",
  "Loss or theft of assets while in transit",
  "Market-value shortfall during the transfer window",
];
